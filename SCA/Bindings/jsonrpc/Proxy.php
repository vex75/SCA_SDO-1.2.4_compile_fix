...
|         Simon Laws                                                          |
+-----------------------------------------------------------------------------+
$Id: Proxy.php,v 1.1.2.1.2.2 2007/03/20 14:17:24 mfp Exp $
*/
...
require "SCA/Bindings/jsonrpc/SCA_JsonRpcClient.php";
...
if (! class_exists('SCA_Bindings_Jsonrpc_Proxy', false)) {
