...
{
	return sdo_do_has_dimension(object, offset, check_empty TSRMLS_CC);
}
...
{
	return sdo_do_read_dimension(object, offset, type TSRMLS_CC);
}
...
{
	sdo_do_unset_dimension(object, offset TSRMLS_CC);
}
...
{
	return sdo_do_write_dimension(object, offset, z_propertyValue TSRMLS_CC);
}
